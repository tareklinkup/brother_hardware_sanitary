...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("due_reminder_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="" style="display: none;">
				<a href="<?php echo base_url(); ?>due_reminder_record">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Due Reminder </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
...
<?php } elseif ($module == 'PurchaseModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("supplier_order", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>supplier_order">
					<i class="menu-icon fa fa-shopping-cart"></i>
					<span class="menu-text"> Order Entry </span>
				</a>
				<b class="arrow"></b>
		...
		<?php if (array_search("supplierOrderRecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>supplierOrderRecord">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text">Order Record</span>
				</a>
				<b class="arrow"></b>
