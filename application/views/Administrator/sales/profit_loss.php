        ...
        <div class="col-md-12">
            <form class="form-inline" v-on:submit.prevent="getSearchResult">
                <div class="form-group" style="margin-right: 15px;">
                    ...
                    <select v-model="searchType" id="type" class="form-control" @change="onChangeSearchType"
                ...
                <div class="form-group" style="margin-right: 15px;"
                    :style="{display: searchType == 'customer' ? '' : 'none'}">
                ...
                <div class="form-group" style="margin-right: 15px;"
                    :style="{display: searchType == 'category' ? '' : 'none'}">
                ...
                <div class="form-group" style="margin-right: 15px;"
                    :style="{display: searchType == 'product' ? '' : 'none'}">
                    <label>Product &nbsp;</label>
                ...
                <table id="table1" v-else>
                    ...
                    <tbody v-for="data in reportData">
                        ...
                        <tr style="background-color: #f0f0f0;font-weight: bold;">
                            ...
                            <td style="text-align:right;">
                                {{ data.saleDetails.reduce((prev, cur) => { return prev + parseFloat(cur.purchased_amount) }, 0) | decimal }}
                            </td>
                            <td style="text-align:right;">
                                {{ data.saleDetails.reduce((prev, cur) => { return prev + parseFloat(cur.SaleDetails_TotalAmount) }, 0) | decimal }}
                            </td>
                            <td style="text-align:right;">
                                {{ data.saleDetails.reduce((prev, cur) => { return prev + parseFloat(cur.profit_loss) }, 0) | decimal }}
                            </td>
                        </tr>
                    </tbody>
                    <tfoot style="font-weight:bold;background-color:#e9dcdc;">
                        ...
                        <tr>
                            ...
                            <td colspan="2"></td>
                            <td style="text-align:right;">{{ otherIncomeExpense.customer_payment_discount | decimal }}
                            </td>
                        </tr>
...
new Vue({
    ...
    methods: {
        ...
        async getProfitLoss() {
            let filter = {
                customer: this.selectedCustomer == null || this.selectedCustomer.Customer_SlNo == '' ?
                    '' : this.selectedCustomer.Customer_SlNo,
                categoryId: this.selectedCategory == null || this.selectedCategory
                    .ProductCategory_SlNo == '' ? '' : this.selectedCategory.ProductCategory_SlNo,
