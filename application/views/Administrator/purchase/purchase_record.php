        ...
        <div class="col-md-12">
            <form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
                ...
                <div class="form-group" style="display:none;"
                    v-bind:style="{display: searchType == 'supplier' && suppliers.length > 0 ? '' : 'none'}">
                        ...
                        <template v-for="purchase in purchases">
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <a href="javascript:" title="Edit Purchase" @click="checkReturnAndEdit(purchase)"><i
                                            class="fa fa-edit"></i></a>
                                    <a href="" title="Delete Purchase"
                                        @click.prevent="deletePurchase(purchase.PurchaseMaster_SlNo)"><i
                            ...
                            <tr style="font-weight:bold;">
                                <td colspan="6" style="font-weight:normal;"><strong>Note:
                                    </strong>{{ purchase.PurchaseMaster_Description }}</td>
                ...
                <table class="record-table"
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                {{ purchases.reduce((prev, curr)=>{return prev + parseFloat(curr.PurchaseMaster_AdjustAmount)}, 0) }}
                            </td>
                            <td style="text-align:right;">
