            ...
            <div class="col-xs-12">
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <?php if($type == 'CR') { ?>
                            <td style="text-align:right;"><?php if($type == 'CR'): echo number_format($CPROW->CPayment_discount, 2); else: echo '00.00'; endif; ?></td>
                        <?php } ?>
                        ...
                        <tr>
                            ...
                            <?php if($type == 'CR') { ?>
                                <th style="font-size: 13px; font-weight: 700;text-align:right;"><?php if($type == 'CR'): echo number_format($CPROW->CPayment_discount, 2); else: echo '00.00'; endif; ?></th>
                            <?php } ?>
            ...
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <?php if($type == 'CR') { ?>
                        ...
                        <tr>
                            <td  style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; ">Discount Amount : </td>
