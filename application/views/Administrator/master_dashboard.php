<?php
	...
	$reorderProductCount = $this->db->query("
	select * from (
		select 
			ci.*,
		...
		and ci.branch_id = 1)as tbl 
		where current_quantity <= Product_ReOrederLevel
	")->num_rows();
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li>
							<a href="<?php echo base_url(); ?>reorder_list" class="icon-button">
								<i class="ace-icon fa fa-bell"></i>
								<span class="icon-button__badge"><?php echo $reorderProductCount ?></span>
							</a>
						</li>
						<?php 
