...
<div class="row" id="purchase">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"> Order For </label>
				<div class="col-sm-3">
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<input type="number" id="adjustAmount" name="adjustAmount" class="form-control" v-model="purchase.adjustAmount" v-on:input="calculateTotal" />
												</div>
											</div>
										</td>
									</tr>
	...
	new Vue({
		...
		methods:{
			...
			calculateTotal(){
				...
				this.purchase.total = ((parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat) + parseFloat(this.purchase.freight) + parseFloat(this.purchase.adjustAmount)) - parseFloat(this.purchase.discount)).toFixed(2);
			...
			savePurchase(){
				...
				let url = '/add_supplier_order';
				if(this.purchase.purchaseId != 0){
					url = '/update_supplier_order';
				}
				...
				axios.post(url, data).then(async res => {
					...
					if(r.success){
						...
						if(conf){
							window.open(`/supplier_invoice_print/${r.purchaseId}`, '_blank');
							await new Promise(r => setTimeout(r, 1000));
							window.location = '/supplier_order';
						} else {
							window.location = '/supplier_order';
						}
					} else {
			...
			getPurchase(){
				axios.post('/get_purchases', {purchaseId: this.purchase.purchaseId}).then(res => {
					...
					this.purchase.adjustAmount = purchase.PurchaseMaster_AdjustAmount;
