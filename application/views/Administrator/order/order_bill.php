...
<div id="purchaseInvoiceReport" class="row">
  ...
  <div class="col-md-8 col-md-offset-2">
    <br>
    <supplier-order-invoice v-bind:purchase_id="selectedInvoice.PurchaseMaster_SlNo" v-if="showInvoice"></supplier-order-invoice>
  </div>
</div>
...
<script>
  ...
  new Vue({
    ...
    methods: {
      getPurchases() {
        axios.get("/get_supplier_order").then(res => {
