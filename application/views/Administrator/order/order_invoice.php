...
<div id="orderInvoiceReport" class="row">
  ...
  <div class="col-md-8 col-md-offset-2">
    <br>
    <order-invoice v-bind:sales_id="selectedInvoice.SaleMaster_SlNo" v-if="showInvoice"></order-invoice>
  </div>
</div>
